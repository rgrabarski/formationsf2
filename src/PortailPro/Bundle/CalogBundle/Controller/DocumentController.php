...
use PortailPro\Bundle\CalogBundle\Entity\Document;
use PortailPro\Bundle\CalogBundle\Form\DocumentType;
...
class DocumentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PortailProCalogBundle:Document')->findAll();
     ...
     * @Method("POST")
     * @Template("PortailProCalogBundle:Document:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PortailProCalogBundle:Document')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PortailProCalogBundle:Document:edit.html.twig")
     */
