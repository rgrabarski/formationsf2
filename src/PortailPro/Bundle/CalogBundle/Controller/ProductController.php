...
class ProductController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PortailProCalogBundle:Product')->findAll();
     ...
     * @Method("POST")
     * @Template("PortailProCalogBundle:Product:new.html.twig")
     */
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PortailProCalogBundle:Product:edit.html.twig")
     */
